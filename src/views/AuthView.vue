 ...
 <div class="card-container">
  ...
  <div class="auth-container">
    <div class="login-card">
        ...
        <a @click="router.push('/forgot-password')" class="forgot-link">Esqueci minha senha</a>
        <div class="d-grid gap-3 d-md-flex justify-content-between">
            <button @click="router.push('/register')" class="btn w-100" type="button">
                Registrar
            </button>
        
            <button @click="login" class="btn btn-primary w-100" type="button">
                Login
            </button>
        </div>
    </div>
...
import router from '@/router';
    ...
    export default{
        ...
        setup(){
            ...
            const login = async () => {
                try{
                    await AuthService.postLogin(user.value)

                    addNotfication('success', 'login com sucesso')
                    ...
                    addNotfication('fail', 'login falhou')
