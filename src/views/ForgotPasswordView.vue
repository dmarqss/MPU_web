  ...
  <div class="auth-container">
    <div class="login-card">
        ...
        <div class="d-grid gap-3 d-md-flex justify-content-between">
            <button @click="router.push('/login')" class="btn w-100" type="button">
                Voltar
            </button>
        
            <button @click="forgotPassword" class="btn btn-primary w-100" type="button">
                Enviar
            </button>
        </div>
    </div>
    ...
    export default{
        ...
        setup(){
            ...
            const forgotPassword = async () => {
                try{
                    UserService.forgotPassword(email.value)

                    addNotfication('success', 'email enviado com sucesso')
                    ...
                    addNotfication('fail', 'o envio falhou')
